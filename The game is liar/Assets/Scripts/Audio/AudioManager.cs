...
<<<<<<< Updated upstream:The game is liar/Assets/Scripts/Audio/AudioManager.cs
    public void Init()
=======
    ...
    void Init()
>>>>>>> Stashed changes:The game is liar/Assets/Scripts/Runtime/Shared & Utilities/Audio/AudioManager.cs
    {
        if (!instance)
        {
            instance = this;

...
public class FallingStar : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Increasing it to full-res and the UniversalRenderPipelineAsset.renderScale to 1.5 fixes the problem
        // com.unity.render-pipelines.universal(10.5.1)/Runtime/Passes/PostProcessPass.cs:927:13

...
[VolumeComponentMenuForRenderPipeline("Custom/Long Bloom", typeof(UniversalRenderPipeline))]
public class LongBloom : VolumeComponent, IPostProcessComponent
{
    [Header("Bloom")]
    ...
    public bool IsActive() => true; // intensity.value > 0f

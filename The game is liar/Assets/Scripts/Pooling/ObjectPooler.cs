...
<<<<<<< Updated upstream:The game is liar/Assets/Scripts/Pooling/ObjectPooler.cs
=======
...
>>>>>>> Stashed changes:The game is liar/Assets/Scripts/Runtime/Shared & Utilities/Pooling/ObjectPooler.cs
    public void Init()
    {
        if (!instance)
        {
